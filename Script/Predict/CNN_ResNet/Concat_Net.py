...
def Concat_block(inputs):
    x1=Conv2D(50,(3,3),padding='same',activation='relu',data_format="channels_last")(inputs)
    b1=BatchNormalization(axis=3)(x1)
    r1=Activation('relu')(b1) 
    x2=Conv2D(24,(1,1),padding='same')(r1)
    r2=Activation('relu')(x2)  
    x3=Conv2D(50,(3,3),padding='same')(r2)   
    b3=BatchNormalization(axis=3)(x3)   
    m1=merge([b3,inputs],mode='concat',concat_axis=3) 
    r3=Activation('relu')(m1)
    return r3 
    
def ModelBuild(model,input_shape):
    inputs = Input(input_shape)
    c1=Conv2D(50,(3,3),padding='same',input_shape=input_shape,data_format="channels_last",name="Conv1")(inputs)
    b1=BatchNormalization(axis=3)(c1)
    r1=Activation('relu')(b1)
    c2=Conv2D(50,(3,3),padding='same',name="Conv2")(r1)
