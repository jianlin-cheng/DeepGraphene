...
###########################################################################################################   
    Model.add(Conv2D(50,(3,3),padding='same',input_shape=input_shape,data_format="channels_last",kernel_initializer='RandomNormal',activation='relu',name="Conv1"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_1'))
    Model.add(Conv2D(48,(2,2),padding='same',activation='relu',name="Conv2"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_2'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv3"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_3'))
    Model.add(Conv2D(48,(2,2),padding='same',activation='relu',name="Conv4"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_4'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv5"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_5'))
    Model.add(Conv2D(48,(2,2),padding='same',activation='relu',name="Conv6"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_6'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv7"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_7'))
    Model.add(Conv2D(48,(2,2),padding='same',activation='relu',name="Conv8"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_8'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv9"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_9'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv10"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_10'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv11"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_11'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv12"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_12'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv13"))
    Model.add(BatchNormalization(axis=3,name='BatchNorm_13'))
    Model.add(Conv2D(50,(2,2),padding='same',activation='relu',name="Conv14"))
...
###########################################################################################################   
    ...
    Model.add(Dense(64,activation='relu',name='DenseLay_2'))
    Model.add(Dense(48,activation='relu',name='DenseLay_3'))
    Model.add(Dense(12,activation='relu',name='DenseLay_4'))
    Model.add(Dropout(0.3,name='Drop_2'))
    Model.add(Dense(1,activation='relu',name='OutLay'))  #Don't change
...
########################################################################################################### 
    ...
    print('/*******************************************************/\n') 
    #Network.fit(Docx,DocY,batch_size=batch_size,epochs=epoch,shuffle=True,validation_split=0.10)
