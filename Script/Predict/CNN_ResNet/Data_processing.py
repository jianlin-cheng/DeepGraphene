...
def X_loading(data_dir,Type,num_file):
    print('\n**********************************************')
    print('   Now Loading the data of Input: (Type)'+ Type+' :' )
    print('**********************************************')
    time.sleep(2)
...
def Y_loading(data_dir,Type,num_file):
    print('\n**********************************************')
    print('   Now Loading the data of Output: (Type) '+Type+' :')
    print('**********************************************')
    time.sleep(1)
...
def Data_process(data_dir,num_file):
    InputX_4by4=X_loading(data_dir,'Train_Data',num_file)
    InputX_5by5=X_loading_5by5(data_dir,'Train_Data_5by5',num_file)
    InputY_4by4=Y_loading(data_dir,'Train_Data',num_file)
    InputY_5by5=Y_loading(data_dir,'Train_Data_5by5',num_file)
