...
data_dir=strcat(char(data_dir(1)),'dataset/');
Train_dir=strcat(data_dir,'Train_Data/');
Test_dir=strcat(data_dir,'Test_Data/');
%-------------------------------------------------------------------------
...
fprintf('**********************************************************\n');
clearvars local_dir data_dir Test_dir Train_dir Train_X_Dir Train_Y_Dir Test_X_Dir Test_Y_Dir
clearvars Train_X_Info Train_Y_Info Test_X_Info Test_Y_Info
clearvars Train_X_filename Train_Y_filename Test_X_filename Test_Y_filename
clearvars tempx tempy Length_Test Length_train
%--------------------------------------------------------------------------
...
fprintf('**********************************************************\n');
%--------------------------------------------------------------------------
% Predict_Y=t_Y=predict(ModelSVM,Test_X)
