...
for i=1:length(Train_X)
    ...
    data_dir_X=strcat('./Data/Train_Data_6by6/InputX/',file_name_X);
    data_dir_Y=strcat('./Data/Train_Data_6by6/InputY/',file_name_Y);
...
for i=1:length(Test_X)
    ...
    file_name_X=strcat('InputX_',strcat(num2str(i),'.csv'));
    file_name_Y=strcat('InputY_',strcat(num2str(i),'.csv'));
    data_dir_X=strcat('./Data/Test_Data_6by6/InputX/',file_name_X);
    data_dir_Y=strcat('./Data/Test_Data_6by6/InputY/',file_name_Y);
    csvwrite(data_dir_X,tempx);
    csvwrite(data_dir_Y,tempy);
end
