...
def load_data(local_dir,Type):
    ...
    for line in fp_text_x:
       ...
       if count%1000==0:
           print(count)
           print("Number of X has been loaded")
       if '' in col:
           col.remove('')
...
def merge_Hash_5by5(data_5by5):
    Hash={'5by5_data':data_5by5}
    return Hash
...
def X_loading(data_dir,Type,num_file):
     ...
     print('**********************************************')
     time.sleep(2)
     DataBase_dir=data_dir+'dataset/data/'+Type+'/InputX/'
...
def Y_loading(data_dir,Type,num_file):
     ...
     print('**********************************************')
     time.sleep(1)
     DataBase_dir=data_dir+'dataset/data/'+Type+'/InputY/'
     Data=[]
 #-------------------------------------------------------------
 #   the number of file in this folder
 #-------------------------------------------------------------    
...
def Data_process(data_dir,Four_num=10000,Five_num=10000,Six_num=10000):
     ...
     InputX=merge_Hash_5by5(InputX_5by5)
     InputY=merge_Hash_5by5(InputY_5by5)
     return InputX,InputY
